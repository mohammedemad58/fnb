...
class _changepassState extends State<changepass> {
  ...
  TextEditingController confirmpass1 = new TextEditingController();
                      ...
                      child: ClipRRect(
                        child: SizedBox(height: 50, child:  ElevatedButton(
                          ...
                          onPressed: () async {
                            ...
                            if(current1.text==password && password1.text==confirmpass1.text && password1.text!='' &&confirmpass1.text!='' &&ver==true)
                            {
                              SendData();
                            ...
                            else if(current1.text=='' && password1.text=='' && confirmpass1.text=='')
                            {
                              Fluttertoast.showToast(
