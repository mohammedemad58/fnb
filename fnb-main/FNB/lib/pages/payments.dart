...
import 'package:fnb/pages/education.dart';
import 'package:fnb/pages/electricity.dart';
import 'package:fnb/pages/gas.dart';
import 'package:fnb/pages/home.dart';
import 'package:fnb/pages/currencies.dart';
import 'package:fnb/pages/ministat.dart';
import 'package:fnb/pages/profile.dart';
import 'package:fnb/pages/telecom.dart';
import 'package:fnb/pages/transfer.dart';
import 'package:fnb/pages/mytrans.dart';
import 'package:fnb/pages/water.dart';
...
SizedBox(width: 30,),
                  ...
                  Container(
                    child: FloatingActionButton.extended(onPressed: (){
                      ...
                      Navigator.push(context, MaterialPageRoute(builder:
                          (context)=> water(data: data, name: name, dob1: dob1, nationality: nationality, gender: gender, mart: mart, add: add, emailadd: emailadd, homenum: homenum, mobilenum: mobilenum, jobb: jobb, jobbadd: jobbadd, income: income, type: type, id: id, accountnum1: accountnum1, balance1: balance1, money: money, username: username, password: password)),   );
                  ...
                  Container(
                    child: FloatingActionButton.extended(onPressed: (){
                      ...
                      Navigator.push(context, MaterialPageRoute(builder:
                          (context)=> gas(data: data, name: name, dob1: dob1, nationality: nationality, gender: gender, mart: mart, add: add, emailadd: emailadd, homenum: homenum, mobilenum: mobilenum, jobb: jobb, jobbadd: jobbadd, income: income, type: type, id: id, accountnum1: accountnum1, balance1: balance1, money: money, username: username, password: password)),   );
