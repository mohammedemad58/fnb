            ...
            children: [
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Center( child: Text('Please note that your maximum requests for loans are 3 times'.tr,style: TextStyle(fontSize: 11.5,fontWeight: FontWeight.bold,color: Color(
                        0xff8d0000)),textAlign: TextAlign.center),),
